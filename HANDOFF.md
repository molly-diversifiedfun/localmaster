...
In flight, in order: **#2 release-ready export → #3 style presets (gated on Molly's listening verdict) → #4 multiband → #5 housekeeping.** (#1 reference-matching UI shipped 2026-07-05 — screenshot-verified live; spec at `docs/superpowers/specs/2026-07-05-refmatch-ui.md`.)
